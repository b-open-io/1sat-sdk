...
// ---------------------------------------------------------------------------
// wallet-api: application-facing BRC-100 endpoint (dApp connectivity)
// ---------------------------------------------------------------------------

const DEFAULT_DAPP_HOST = '127.0.0.1'
...
async function startDappEndpoint(
	...
	const host = dapp.host ?? DEFAULT_DAPP_HOST
	const port =
		dapp.port ??
		(process.env.ONESAT_DAPP_PORT
